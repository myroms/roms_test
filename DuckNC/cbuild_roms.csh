...
# CPP definitions. REQUIRED
 ...
 setenv ROMS_APPLICATION     DUCKNC
...
if ( $pio_lib == 1 ) then
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DAVERAGES"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DAVERAGES_WEC"
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DROLLER_RENIERS"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DROLLER_SVENDSEN"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSURFACE_STREAMING"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_KIRBY"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DWDIS_WAVEMOD"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_LOGDRAG"
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSSW_LOGINT_WBL"
