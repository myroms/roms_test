...
if [ $pio_lib -eq 1 ]; then
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DAVERAGES"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DAVERAGES_WEC"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DDIAGNOSTICS_TS"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DDIAGNOSTICS_UV"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DWEC_VF"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DROLLER_RENIERS"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DROLLER_SVENDSEN"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBOTTOM_STREAMING"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_KIRBY"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DWDIS_WAVEMOD"
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_LOGDRAG"
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSSW_LOGINT_WBL"
