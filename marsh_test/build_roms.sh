...
export   ROMS_APPLICATION=MARSH_TEST
...
if [ $pio_lib -eq 1 ]; then
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DVEGETATION"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMARSH_KIRWAN_FORMULATION"       # choose one
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DMARSH_MCKEE_FORMULATION"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSEDIMENT"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBEDLOAD_VANDERA"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBEDLOAD_VANDERA_MADSEN_UDELTA"  # choose one
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DBEDLOAD_VANDERA_DIRECT_UDELTA"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSSW_BBL"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSSW_LOGINT_WBL"                 # choose one
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSSW_LOGINT_DIRECT"
