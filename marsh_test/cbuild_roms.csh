...
# CPP definitions. REQUIRED
 ...
 setenv ROMS_APPLICATION     MARSH_TEST
...
if ( $pio_lib == 1 ) then
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DVEGETATION"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DMARSH_KIRWAN_FORMULATION"       # choose one
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DMARSH_MCKEE_FORMULATION"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSEDIMENT"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DBEDLOAD_VANDERA"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DBEDLOAD_VANDERA_MADSEN_UDELTA"  # choose one
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DBEDLOAD_VANDERA_DIRECT_UDELTA"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSSW_BBL"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSSW_LOGINT_WBL"                 # choose one
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSSW_LOGINT_DIRECT"
...
#setnev MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTKE_WAVEDISS"

#setevn MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSALINITY"
