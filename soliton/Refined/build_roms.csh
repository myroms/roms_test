...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DREFINE_BOUNDARY"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DNESTING_DEBUG"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DTIME_INTERP_FLUX"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DONE_WAY"

#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_C2ADVECTION"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DUV_C4ADVECTION"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSTEP2D_FB_LF_AM3"
...
if ($?USE_DEBUG) then
  ...
  if ($?USE_OpenMP) then
    setenv SCRATCH_DIR      ${MY_PROJECT_DIR}/Build_romsO
  else if ($?USE_MPI) then
    setenv SCRATCH_DIR      ${MY_PROJECT_DIR}/Build_romsM
  else
