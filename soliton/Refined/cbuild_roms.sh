#!/bin/bash
#
# svn $Id: cbuild_roms.sh 1174 2023-06-17 20:34:48Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DNESTING_DEBUG"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DTIME_INTERP_FLUX"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DONE_WAY"

#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_C2ADVECTION"
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_C4ADVECTION"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_UV_LDRAG"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_UV_QDRAG"

 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DUV_VIS2"

#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSTEP2D_FB_LF_AM3"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DSTEP2D_FB_AB3_AM4"
