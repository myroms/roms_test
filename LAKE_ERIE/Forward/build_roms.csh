...
setenv ROMS_APPLICATION      LAKE_ERIE
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DALBEDO"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_CLOUD"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_HUMIDITY"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_PAIR"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_RAIN"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_SRFLUX"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_TAIR"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DANA_WINDS"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DICE_MODEL"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DNONLIN_EOS"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DOMEGA_IMPLICIT"
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DATM_PRESS"

 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DSTEP2D_FB_AB3_AM4"
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DDIAGNOSTIC_TS"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DDIAGNOSTIC_UV"
