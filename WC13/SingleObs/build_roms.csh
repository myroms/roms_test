...
# git $Id$
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
# Copyright (c) 2002-2023 The ROMS Group                                :::
...
#setenv  MY_ROMS_SRC        ${OCEANHOME}/repository/git/trunk
#setenv  MY_ROMS_SRC        ${OCEANHOME}/repository/svn/tags/roms-4.1
#setenv  MY_ROMS_SRC        ${OCEANHOME}/repository/svn/trunk
...
#setevn MY_CPP_FLAGS "${MY_CPP_FLAGS} -DASYNCHRONOUS_PIO"
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DASYNCHRONOUS_SCORPIO"
...
# etc).
 ...
 setenv UP_DIR              `dirname ${PWD}`
 setenv MY_ANALYTICAL_DIR   `dirname ${UP_DIR}`/Functionals
...
# For backward compatibility, set SCRATCH_DIR to compile older released
# versions of ROMS.
