...
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DPOSITIVE_ZERO"
 ...
 export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DPIO_LIB"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DASYNCHRONOUS_PIO"
#export      MY_CPP_FLAGS="${MY_CPP_FLAGS} -DASYNCHRONOUS_SCORPIO"
...
# etc).
 ...
 export            UP_DIR=`dirname ${PWD}`
 export MY_ANALYTICAL_DIR=`dirname ${UP_DIR}`/Functionals
