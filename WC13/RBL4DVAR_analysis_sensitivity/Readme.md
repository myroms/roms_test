...
constraint, dual formulation, of 4-Dimensional Variational (**4D-Var**)
...
- Customize the configuration script **job_rbl4dvar_sen.csh** and provide
...
- Execute the configuration **job_rbl4dvar_sen.csh** `BEFORE` running
...
- Run **RBL4D-Var** analysis observations sensitivity:
  ```
