...
## 4D-Var Tutorial: Verifying Analysis

**Infomation:**              www.myroms.org/wiki/4DVar_Tutorial_Introduction

**Observation Impacts:**      www.myroms.org/wiki/RBL4DVAR_Forecast_Observation_Impact_Tutorial

**Observation Sensitivity:**  www.myroms.org/wiki/RBL4DVAR_Forecast_Observation_Sensitivity_Tutorial
...
The verifying analysis is computed by running a second **RBL4D-Var**
analysis cycle for the following 7-day window: **07-Jan-2004 00:00:00** GMT
to **14-Jan-2004 00:00:00** GMT

It is initialized with the first **RBL4D-Var** analysis cycle (**wc13_dai.nc**)
...
- We recommend creating new subdirectories **daily** or
  **2hours** to save the solution that will be used in the
  Forecast Impacts and Forecast Sensitivity. For example:
  ```
      mkdir daily
